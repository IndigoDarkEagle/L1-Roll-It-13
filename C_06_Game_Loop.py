...
while comp_score < game_goal and user_score < game_goal:
    ...
    # Start of round loop
    # For testing purpose, ask the user what the points for the user / computer were
    # Roll the dice for the user and unpack the returned values
    user_points, double_user = initial_points("User")
    comp_points, double_comp = initial_points("Comp")
